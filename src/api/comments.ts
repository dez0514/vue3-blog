...
export const addReply = (params: any = {}, config: any = {}) => {
  const data = qs.stringify(params)
  return service.post('/api/comment/add_replys', data, { ...config, headers: { 'Content-Type' : 'application/x-www-form-urlencoded' }})
}
